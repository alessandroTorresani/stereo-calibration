...
void setup_calibration(int board_width, int board_height, float square_size, const vector<string> imgFilepaths) {
  Size board_size = Size(board_width, board_height);
  int board_n = board_width * board_height;

  for(string imgPath : imgFilepaths) {
    ...
    if (found) {
      cout << imgPath << ". Found corners!" << endl;
...
int main(int argc, char const **argv)
{
  ...
  getImgFilepaths(imgs_directory, extension, imgFilepaths);

  setup_calibration(board_width, board_height, square_size, imgFilepaths);
